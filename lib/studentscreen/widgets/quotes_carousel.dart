    ...
    try {
      ...
      if (mounted) {
        ...
        if (_quotes.isNotEmpty) {
          debugPrint('QuotesCarousel: Starting rotation with ${_quotes.length} quotes');
          _startRotation();
        } else {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: const Color(0xFF060E57).withAlpha((0.2 * 255).round()),
                    blurRadius: 12,
            ...
            if (currentQuote.authorName != null && currentQuote.authorName!.isNotEmpty) ...[
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        color: index == actualIndex
                            ...
                            : const Color(0xFF060E57).withAlpha((0.2 * 255).round()),
                        shape: BoxShape.circle,
                      ),
                    );
                  },
